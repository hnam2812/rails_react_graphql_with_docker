...
RSpec.configure do |config|
  ...
  def save_timestamped_screenshot(page, meta) # rubocop:disable Metrics/AbcSize
...
Capybara.register_driver :selenium do |app|
  ...
  Capybara.default_max_wait_time = 40 # to support painfully slow CI browser environment

  browser_options = ::Selenium::WebDriver::Chrome::Options.new
  browser_options.args << "--headless"
  browser_options.args << "--disable-gpu"
  # browser_options.args << '--window-size=1980,960'
  # browser_options.args << '--screenshot'
